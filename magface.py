...
class NetworkBuilder_inf(nn.Module):
    def __init__(self):
        ...
        self.features = iresnet100(pretrained=False, num_classes=512)
...
def load_dict_inf(model):
    checkpoint = torch.load('magface_epoch_00025.pth')
