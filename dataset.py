...
class ImageFolder(Dataset):
    def __init__(self, root, transform):
        ...
        self.imgpaths = self.get_paths()
        self.transform = transform

    def get_paths(self):
        with open('ffhq.txt') as file:
    ...
    def __getitem__(self, idx):
        ...
        name = Path(path).stem
        w = torch.load(f'/shared/rsaas/mchong6/ffhq_e4e/{name}.pt')
        return self.transform(image), w
