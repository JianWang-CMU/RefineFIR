...
import lpips
from model_noid import Discriminator, Denoiser
...
if __name__ == "__main__":
    ...
    writer_path = './runs_noid'
    os.makedirs(writer_path, exist_ok=True)
    os.makedirs('checkpoint_noid', exist_ok=True)
    ...
    for idx in pbar:
        ...
        total_loss = g_loss + vgg_loss + l1_loss
        ...
        if get_rank() == 0:
            if i % 500 == 0:
                with torch.no_grad():
                    sample = torch.cat([im_hq, im_lq, fake_img], 0)
